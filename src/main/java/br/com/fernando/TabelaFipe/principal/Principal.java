...
import br.com.fernando.TabelaFipe.model.Veiculo;
...
public class Principal {
    ...
    public void exibeMenu() {
        ...
        System.out.println("\nDigite um trecho do nome do carro para consultar: ");
        var nomeVeiculo = leitura.nextLine();

        List<Dados> modelosFiltrados = modeloLista.modelos().stream()
                .filter(m -> m.nome().toLowerCase().contains(nomeVeiculo.toLowerCase()))
                .collect(Collectors.toList()); // filtra todos os veiculos que tem o nome parecido com o que foi digitado e gera uma nova lista

        System.out.println("\nModelos filtrados:");
        modelosFiltrados.forEach(System.out::println);

        System.out.println("Digite o código do modelo para consultar os valores da avaliação: ");
